...
fn test_root_directory_completion() {
    assert_eq!(
        ...
        Ok("commands dir_example exec file_example help languages practical_examples read-from-root source_example source_example_fish test_files tome use-arg".to_string())
    );
}
